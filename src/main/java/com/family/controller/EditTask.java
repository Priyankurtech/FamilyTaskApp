    		 ...
    		 TaskDao dao = new TaskDao();
    			...
    			while (resultSet.next()) {
    				String newtaskname = req.getParameter("taskname");
    	 			...
    	 			String query1 = String.format("update familyevent set task_name='%s',task_details='%s' where taskid='%s';",newtaskname,newtaskd,id);
    	 			statement1.executeUpdate(query1);
    	 			con1.close();
    			}
    			resp.getWriter().print("<h1>Task Updated</h1>");
