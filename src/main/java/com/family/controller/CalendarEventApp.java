...
public class CalendarEventApp {
	private static final String APPLICATION_NAME = "FamilyTaskApp";
    /**
    ...
    private static Credential getCredentials(final NetHttpTransport HTTP_TRANSPORT)
            throws IOException {
        // Load client secrets.
        InputStream in = CalendarEventApp.class.getResourceAsStream(CREDENTIALS_FILE_PATH);
        if (in == null) {
